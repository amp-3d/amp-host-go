...
type AppVars struct {
	// HostName is the domain name used for primary queries (e.g. "blockcities.plan.tools")
	HostDomain string `protobuf:"bytes,2,opt,name=HostDomain,proto3" json:"HostDomain,omitempty"`
	// LinkDesc describes a link into this org and is for humans.
...
func (m *AppVars) GetHostDomain() string {
	if m != nil {
		return m.HostDomain
	}
	return ""
...
type AssetEntry struct {
	...
	AssetFlags AssetFlags `protobuf:"varint,1,opt,name=AssetFlags,proto3,enum=crates.AssetFlags" json:"AssetFlags,omitempty"`
	BrowsePath string     `protobuf:"bytes,2,opt,name=BrowsePath,proto3" json:"BrowsePath,omitempty"`
	// Name is the human-readable label for this asset.
	Label string `protobuf:"bytes,3,opt,name=Label,proto3" json:"Label,omitempty"`
	// AssetID is a unique string name that identifies this asset for a given crate.
	// If two or more assets have the same AssetID, then only one is accessible.
...
func (m *AssetEntry) GetAssetFlags() AssetFlags {
	if m != nil {
		return m.AssetFlags
	}
	return NoFlags
...
func (m *AssetEntry) GetBrowsePath() string {
	if m != nil {
		return m.BrowsePath
	}
	return ""
...
var fileDescriptor_44b18017c076fca5 = []byte{
	...
	,
}
...
func (this *AppVars) Equal(that interface{}) bool {
	...
	if this.HostDomain != that1.HostDomain {
		return false
	}
...
func (this *AssetEntry) Equal(that interface{}) bool {
	...
	if this.AssetFlags != that1.AssetFlags {
		return false
	}
	if this.BrowsePath != that1.BrowsePath {
		return false
	}
...
func (this *AppVars) GoString() string {
	...
	s = append(s, "HostDomain: "+fmt.Sprintf("%#v", this.HostDomain)+",\n")
...
func (this *AssetEntry) GoString() string {
	...
	s = append(s, "AssetFlags: "+fmt.Sprintf("%#v", this.AssetFlags)+",\n")
	s = append(s, "BrowsePath: "+fmt.Sprintf("%#v", this.BrowsePath)+",\n")
...
func (m *AppVars) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.CrateSnapshotURL) > 0 {
		...
		i = encodeVarintCrates(dAtA, i, uint64(len(m.CrateSnapshotURL)))
		i--
		dAtA[i] = 0x72
	}
	...
	if len(m.HostDomain) > 0 {
		i -= len(m.HostDomain)
		copy(dAtA[i:], m.HostDomain)
		i = encodeVarintCrates(dAtA, i, uint64(len(m.HostDomain)))
		i--
		dAtA[i] = 0x12
	}
	return len(dAtA) - i, nil
...
func (m *AssetEntry) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.AssetID) > 0 {
		...
		i = encodeVarintCrates(dAtA, i, uint64(len(m.AssetID)))
		i--
		dAtA[i] = 0x22
	}
	if len(m.Label) > 0 {
	...
	if len(m.BrowsePath) > 0 {
		i -= len(m.BrowsePath)
		copy(dAtA[i:], m.BrowsePath)
		i = encodeVarintCrates(dAtA, i, uint64(len(m.BrowsePath)))
		i--
		dAtA[i] = 0x12
	}
	if m.AssetFlags != 0 {
		i = encodeVarintCrates(dAtA, i, uint64(m.AssetFlags))
		i--
		dAtA[i] = 0x8
	}
	return len(dAtA) - i, nil
...
func (m *AssetEntry) Size() (n int) {
	...
	_ = l
	if m.AssetFlags != 0 {
		n += 1 + sovCrates(uint64(m.AssetFlags))
	}
	l = len(m.BrowsePath)
	if l > 0 {
		n += 1 + l + sovCrates(uint64(l))
...
func (this *AppVars) String() string {
	...
	s := strings.Join([]string{`&AppVars{`,
		`HostDomain:` + fmt.Sprintf("%v", this.HostDomain) + `,`,
...
func (this *AssetEntry) String() string {
	...
	s := strings.Join([]string{`&AssetEntry{`,
		`AssetFlags:` + fmt.Sprintf("%v", this.AssetFlags) + `,`,
		`BrowsePath:` + fmt.Sprintf("%v", this.BrowsePath) + `,`,
...
func (m *AppVars) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field HostDomain", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.HostDomain = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 4:
			if wireType != 2 {
...
func (m *AssetEntry) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field AssetFlags", wireType)
			}
			m.AssetFlags = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.AssetFlags |= AssetFlags(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field BrowsePath", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.BrowsePath = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 3:
			if wireType != 2 {
