...
func (KeyType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_7c20b3890972e57f, []int{0}
}
...
func (CryptoKitID) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_7c20b3890972e57f, []int{1}
}
...
func (HashKitID) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_7c20b3890972e57f, []int{2}
}
...
func (CryptOp) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_7c20b3890972e57f, []int{3}
}
...
var ErrCode_name = map[int32]string{
	0:    "ErrCode_NoErr",
	4999: "ErrCode_Unimplemented",
	5000: "ErrCode_UnnamedErr",
	5001: "ErrCode_InternalErr",
	5020: "ErrCode_AssertFailed",
	8001: "ErrCode_CryptoKitAlreadyRegistered",
	8002: "ErrCode_UnrecognizedCryptoKit",
	8007: "ErrCode_DecryptFailed",
	8008: "ErrCode_VerifySignatureFailed",
	8009: "ErrCode_BadKeyFormat",
	8010: "ErrCode_KeyGenerationFailed",
	8011: "ErrCode_KeyringNotFound",
	8012: "ErrCode_KeyEntryNotFound",
	8013: "ErrCode_HashKitNotFound",
	8020: "ErrCode_SessionNotReady",
	8021: "ErrCode_UnrecognizedCryptOp",
	8030: "ErrCode_MarshalFailed",
	8031: "ErrCode_UnmarshalFailed",
}

var ErrCode_value = map[string]int32{
	"ErrCode_NoErr":                      0,
	"ErrCode_Unimplemented":              4999,
	"ErrCode_UnnamedErr":                 5000,
	"ErrCode_InternalErr":                5001,
	"ErrCode_AssertFailed":               5020,
	"ErrCode_CryptoKitAlreadyRegistered": 8001,
	"ErrCode_UnrecognizedCryptoKit":      8002,
	"ErrCode_DecryptFailed":              8007,
	"ErrCode_VerifySignatureFailed":      8008,
	"ErrCode_BadKeyFormat":               8009,
	"ErrCode_KeyGenerationFailed":        8010,
	"ErrCode_KeyringNotFound":            8011,
	"ErrCode_KeyEntryNotFound":           8012,
	"ErrCode_HashKitNotFound":            8013,
	"ErrCode_SessionNotReady":            8020,
	"ErrCode_UnrecognizedCryptOp":        8021,
	"ErrCode_MarshalFailed":              8030,
	"ErrCode_UnmarshalFailed":            8031,
}

func (ErrCode) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_7c20b3890972e57f, []int{4}
}
...
func (*Keyring) Descriptor() ([]byte, []int) {
	return fileDescriptor_7c20b3890972e57f, []int{5}
}
...
func (*KeyTome) Descriptor() ([]byte, []int) {
	return fileDescriptor_7c20b3890972e57f, []int{6}
}
...
func (*SigHeader) Descriptor() ([]byte, []int) {
	return fileDescriptor_7c20b3890972e57f, []int{7}
}
...
func (*KeyTomeCrypt) Descriptor() ([]byte, []int) {
	return fileDescriptor_7c20b3890972e57f, []int{8}
}
...
func (*Err) Descriptor() ([]byte, []int) {
	return fileDescriptor_7c20b3890972e57f, []int{9}
}
...
func init() { proto.RegisterFile("ski/api.ski.proto", fileDescriptor_7c20b3890972e57f) }

var fileDescriptor_7c20b3890972e57f = []byte{
	// 1200 bytes of a gzipped FileDescriptorProto
	,
}
...
func valueToGoStringApiSki(v interface{}, typ string) string {
...
func (m *CryptOpArgs) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.TomeIn != nil {
		{
			...
			i -= size
			i = encodeVarintApiSki(dAtA, i, uint64(size))
		}
		i--
		dAtA[i] = 0x32
	}
	if len(m.PeerKey) > 0 {
		...
		i = encodeVarintApiSki(dAtA, i, uint64(len(m.PeerKey)))
		i--
		dAtA[i] = 0x2a
	}
	if m.OpKey != nil {
	...
	if len(m.BufIn) > 0 {
		i -= len(m.BufIn)
		copy(dAtA[i:], m.BufIn)
		i = encodeVarintApiSki(dAtA, i, uint64(len(m.BufIn)))
		i--
		dAtA[i] = 0x1a
	}
	if m.DefaultCryptoKit != 0 {
		i = encodeVarintApiSki(dAtA, i, uint64(m.DefaultCryptoKit))
		i--
		dAtA[i] = 0x10
	}
	if m.CryptOp != 0 {
		i = encodeVarintApiSki(dAtA, i, uint64(m.CryptOp))
		i--
		dAtA[i] = 0x8
	}
...
func (m *CryptOpOut) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.OpPubKey) > 0 {
		...
		i = encodeVarintApiSki(dAtA, i, uint64(len(m.OpPubKey)))
		i--
		dAtA[i] = 0x12
	}
	if len(m.BufOut) > 0 {
		...
		i = encodeVarintApiSki(dAtA, i, uint64(len(m.BufOut)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *KeyInfo) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.PubKey) > 0 {
		...
		i = encodeVarintApiSki(dAtA, i, uint64(len(m.PubKey)))
		i--
		dAtA[i] = 0x22
	}
	if m.TimeCreated != 0 {
		i = encodeVarintApiSki(dAtA, i, uint64(m.TimeCreated))
		i--
		dAtA[i] = 0x18
	}
	if m.CryptoKitID != 0 {
		i = encodeVarintApiSki(dAtA, i, uint64(m.CryptoKitID))
		i--
		dAtA[i] = 0x10
	}
	if m.KeyType != 0 {
		i = encodeVarintApiSki(dAtA, i, uint64(m.KeyType))
		i--
		dAtA[i] = 0x8
	}
	return len(dAtA) - i, nil
...
func (m *KeyRef) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.KeyringName) > 0 {
		...
		i = encodeVarintApiSki(dAtA, i, uint64(len(m.KeyringName)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *KeyEntry) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.PrivKey) > 0 {
		...
		i = encodeVarintApiSki(dAtA, i, uint64(len(m.PrivKey)))
		i--
		dAtA[i] = 0x32
	}
	if m.KeyInfo != nil {
...
func (m *Keyring) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.NewestPubKey) > 0 {
		...
		i = encodeVarintApiSki(dAtA, i, uint64(len(m.NewestPubKey)))
		i--
		dAtA[i] = 0x22
	}
	if m.SortedByPubKey {
	...
	if len(m.Name) > 0 {
		i -= len(m.Name)
		copy(dAtA[i:], m.Name)
		i = encodeVarintApiSki(dAtA, i, uint64(len(m.Name)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *KeyTome) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.Rev != 0 {
		i = encodeVarintApiSki(dAtA, i, uint64(m.Rev))
		i--
		dAtA[i] = 0x8
	}
	return len(dAtA) - i, nil
...
func (m *SigHeader) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	if m.BodySz != 0 {
		i = encodeVarintApiSki(dAtA, i, uint64(m.BodySz))
		i--
		dAtA[i] = 0x48
	}
	if m.HeaderCodec != 0 {
		i = encodeVarintApiSki(dAtA, i, uint64(m.HeaderCodec))
		i--
		dAtA[i] = 0x40
	}
	if m.HeaderSz != 0 {
		i = encodeVarintApiSki(dAtA, i, uint64(m.HeaderSz))
		i--
		dAtA[i] = 0x38
	}
	if m.HashKitID != 0 {
		i = encodeVarintApiSki(dAtA, i, uint64(m.HashKitID))
		i--
		dAtA[i] = 0x30
	}
	if len(m.SignerPubKey) > 0 {
		...
		i = encodeVarintApiSki(dAtA, i, uint64(len(m.SignerPubKey)))
		i--
		dAtA[i] = 0x12
	}
	if m.SignerCryptoKit != 0 {
		i = encodeVarintApiSki(dAtA, i, uint64(m.SignerCryptoKit))
		i--
		dAtA[i] = 0x8
	}
	return len(dAtA) - i, nil
...
func (m *KeyTomeCrypt) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Tome) > 0 {
		i -= len(m.Tome)
		copy(dAtA[i:], m.Tome)
		i = encodeVarintApiSki(dAtA, i, uint64(len(m.Tome)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *Err) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Msg) > 0 {
		i -= len(m.Msg)
		copy(dAtA[i:], m.Msg)
		i = encodeVarintApiSki(dAtA, i, uint64(len(m.Msg)))
		i--
		dAtA[i] = 0x12
	}
	if m.Code != 0 {
		i = encodeVarintApiSki(dAtA, i, uint64(m.Code))
		i--
		dAtA[i] = 0x8
	}
	return len(dAtA) - i, nil
...
func encodeVarintApiSki(dAtA []byte, offset int, v uint64) int {
	offset -= sovApiSki(v)
	base := offset
	for v >= 1<<7 {
...
func (m *CryptOpArgs) Size() (n int) {
	...
	_ = l
	if m.CryptOp != 0 {
		n += 1 + sovApiSki(uint64(m.CryptOp))
	}
	if m.DefaultCryptoKit != 0 {
		n += 1 + sovApiSki(uint64(m.DefaultCryptoKit))
	}
	l = len(m.BufIn)
	if l > 0 {
		n += 1 + l + sovApiSki(uint64(l))
	}
	if m.OpKey != nil {
		l = m.OpKey.Size()
		n += 1 + l + sovApiSki(uint64(l))
...
func (m *KeyInfo) Size() (n int) {
	...
	_ = l
	if m.KeyType != 0 {
		n += 1 + sovApiSki(uint64(m.KeyType))
	}
	if m.CryptoKitID != 0 {
		n += 1 + sovApiSki(uint64(m.CryptoKitID))
	}
	if m.TimeCreated != 0 {
		n += 1 + sovApiSki(uint64(m.TimeCreated))
	}
	l = len(m.PubKey)
	if l > 0 {
		n += 1 + l + sovApiSki(uint64(l))
...
func (m *SigHeader) Size() (n int) {
	...
	_ = l
	if m.SignerCryptoKit != 0 {
		n += 1 + sovApiSki(uint64(m.SignerCryptoKit))
	}
	...
	if m.HashKitID != 0 {
		n += 1 + sovApiSki(uint64(m.HashKitID))
	}
	if m.HeaderSz != 0 {
		n += 1 + sovApiSki(uint64(m.HeaderSz))
	}
	if m.HeaderCodec != 0 {
		n += 1 + sovApiSki(uint64(m.HeaderCodec))
	}
	if m.BodySz != 0 {
		n += 1 + sovApiSki(uint64(m.BodySz))
	}
	return n
}
...
func sovApiSki(x uint64) (n int) {
	return (math_bits.Len64(x|1) + 6) / 7
}
func sozApiSki(x uint64) (n int) {
	return sovApiSki(uint64((x << 1) ^ uint64((int64(x) >> 63))))
}
...
func valueToStringApiSki(v interface{}) string {
	rv := reflect.ValueOf(v)
	if rv.IsNil() {
		return "nil"
	}
...
func (m *CryptOpArgs) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		default:
			iNdEx = preIndex
			skippy, err := skipApiSki(dAtA[iNdEx:])
			if err != nil {
				return err
			}
...
func skipApiSki(dAtA []byte) (n int, err error) {
	l := len(dAtA)
	iNdEx := 0
	depth := 0
	for iNdEx < l {
		...
		case 2:
			...
			if length < 0 {
				return 0, ErrInvalidLengthApiSki
			}
			iNdEx += length
		case 3:
			depth++
		case 4:
			if depth == 0 {
				return 0, ErrUnexpectedEndOfGroupApiSki
			}
			depth--
		case 5:
			iNdEx += 4
...
var (
	ErrInvalidLengthApiSki        = fmt.Errorf("proto: negative length found during unmarshaling")
	ErrIntOverflowApiSki          = fmt.Errorf("proto: integer overflow")
	ErrUnexpectedEndOfGroupApiSki = fmt.Errorf("proto: unexpected end of group")
)
