...
// source: pxr/pxr.proto

// package pxr is an implementation-independent API and support for a distributed
...
func (Const) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_9838d0ddeb1ed0fc, []int{0}
}
...
func (ValType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_9838d0ddeb1ed0fc, []int{1}
}
...
const (
	...
	// Signals the insertion of a new cell as a child of the pinned cell (with MsgOp_PushAttr and MsgOp_Checkpoint to follow).
	//
	// Params:
	//      Msg.ReqID:      originating request ID
	//      Msg.CellID:     the child cell being added
...
func (MsgOp) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_9838d0ddeb1ed0fc, []int{2}
}
...
func (SeriesType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_9838d0ddeb1ed0fc, []int{3}
}
...
func (GeoModel) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_9838d0ddeb1ed0fc, []int{4}
}
...
func (CryptoKitID) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_9838d0ddeb1ed0fc, []int{5}
}
...
func (ErrCode) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_9838d0ddeb1ed0fc, []int{6}
}
...
func (TRS_VisualScaleMode) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_9838d0ddeb1ed0fc, []int{14, 0}
}

type Msg struct {
	// Describes how this Msg should be interpreted
	Op MsgOp `protobuf:"varint,1,opt,name=Op,proto3,enum=pxr.MsgOp" json:"Op,omitempty"`
...
type AttrSpec struct {
	...
	SeriesType SeriesType `protobuf:"varint,6,opt,name=SeriesType,proto3,enum=pxr.SeriesType" json:"SeriesType,omitempty"`
...
func (*AttrSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_9838d0ddeb1ed0fc, []int{7}
}
...
type PinReq struct {
	...
	PinURI string `protobuf:"bytes,3,opt,name=PinURI,proto3" json:"PinURI,omitempty"`
	...
	PinCellSchema int32 `protobuf:"varint,7,opt,name=PinCellSchema,proto3" json:"PinCellSchema,omitempty"`
...
func (*PinReq) Descriptor() ([]byte, []int) {
	return fileDescriptor_9838d0ddeb1ed0fc, []int{8}
}
...
func (m *PinReq) GetPinCellSchema() int32 {
	if m != nil {
		return m.PinCellSchema
	}
	return 0
}
...
func (*AttrRange) Descriptor() ([]byte, []int) {
	return fileDescriptor_9838d0ddeb1ed0fc, []int{9}
}
...
type GeoFix struct {
	Model  GeoModel `protobuf:"varint,1,opt,name=Model,proto3,enum=pxr.GeoModel" json:"Model,omitempty"`
...
func (*GeoFix) Descriptor() ([]byte, []int) {
	return fileDescriptor_9838d0ddeb1ed0fc, []int{10}
}
...
func (*Content) Descriptor() ([]byte, []int) {
	return fileDescriptor_9838d0ddeb1ed0fc, []int{11}
}
...
type CryptoKey struct {
	CryptoKitID CryptoKitID `protobuf:"varint,1,opt,name=CryptoKitID,proto3,enum=pxr.CryptoKitID" json:"CryptoKitID,omitempty"`
...
func (*CryptoKey) Descriptor() ([]byte, []int) {
	return fileDescriptor_9838d0ddeb1ed0fc, []int{12}
}
...
func (*Link) Descriptor() ([]byte, []int) {
	return fileDescriptor_9838d0ddeb1ed0fc, []int{13}
}
...
type TRS struct {
	...
	ScaleMode TRS_VisualScaleMode `protobuf:"varint,50,opt,name=ScaleMode,proto3,enum=pxr.TRS_VisualScaleMode" json:"ScaleMode,omitempty"`
...
func (*TRS) Descriptor() ([]byte, []int) {
	return fileDescriptor_9838d0ddeb1ed0fc, []int{14}
}
...
func (*FeedParams) Descriptor() ([]byte, []int) {
	return fileDescriptor_9838d0ddeb1ed0fc, []int{15}
}
...
func (*DataSegment) Descriptor() ([]byte, []int) {
	return fileDescriptor_9838d0ddeb1ed0fc, []int{16}
}
...
type Err struct {
	...
	Code ErrCode `protobuf:"varint,1,opt,name=Code,proto3,enum=pxr.ErrCode" json:"Code,omitempty"`
...
func (*Err) Descriptor() ([]byte, []int) {
	return fileDescriptor_9838d0ddeb1ed0fc, []int{17}
}
...
func init() {
	proto.RegisterEnum("pxr.Const", Const_name, Const_value)
	proto.RegisterEnum("pxr.ValType", ValType_name, ValType_value)
	proto.RegisterEnum("pxr.MsgOp", MsgOp_name, MsgOp_value)
	proto.RegisterEnum("pxr.SeriesType", SeriesType_name, SeriesType_value)
	proto.RegisterEnum("pxr.GeoModel", GeoModel_name, GeoModel_value)
	proto.RegisterEnum("pxr.CryptoKitID", CryptoKitID_name, CryptoKitID_value)
	proto.RegisterEnum("pxr.ErrCode", ErrCode_name, ErrCode_value)
	proto.RegisterEnum("pxr.TRS_VisualScaleMode", TRS_VisualScaleMode_name, TRS_VisualScaleMode_value)
	proto.RegisterType((*Msg)(nil), "pxr.Msg")
	proto.RegisterType((*PlanetEpoch)(nil), "pxr.PlanetEpoch")
	proto.RegisterType((*UserSeat)(nil), "pxr.UserSeat")
	proto.RegisterType((*LoginReq)(nil), "pxr.LoginReq")
	proto.RegisterType((*Symbol)(nil), "pxr.Symbol")
	proto.RegisterType((*Defs)(nil), "pxr.Defs")
	proto.RegisterType((*AttrSchema)(nil), "pxr.AttrSchema")
	proto.RegisterType((*AttrSpec)(nil), "pxr.AttrSpec")
	proto.RegisterType((*PinReq)(nil), "pxr.PinReq")
	proto.RegisterType((*AttrRange)(nil), "pxr.AttrRange")
	proto.RegisterType((*GeoFix)(nil), "pxr.GeoFix")
	proto.RegisterType((*Content)(nil), "pxr.Content")
	proto.RegisterType((*CryptoKey)(nil), "pxr.CryptoKey")
	proto.RegisterType((*Link)(nil), "pxr.Link")
	proto.RegisterType((*TRS)(nil), "pxr.TRS")
	proto.RegisterType((*FeedParams)(nil), "pxr.FeedParams")
	proto.RegisterType((*DataSegment)(nil), "pxr.DataSegment")
	proto.RegisterType((*Err)(nil), "pxr.Err")
}

func init() { proto.RegisterFile("pxr/pxr.proto", fileDescriptor_9838d0ddeb1ed0fc) }

var fileDescriptor_9838d0ddeb1ed0fc = []byte{
	// 2231 bytes of a gzipped FileDescriptorProto
	,
}
...
func (this *PinReq) Equal(that interface{}) bool {
	...
	if this.PinCellSchema != that1.PinCellSchema {
		return false
	}
...
func (this *PinReq) GoString() string {
	...
	s = append(s, "PinCellSchema: "+fmt.Sprintf("%#v", this.PinCellSchema)+",\n")
...
func valueToGoStringPxr(v interface{}, typ string) string {
...
func (c *hostGrpcClient) HostSession(ctx context.Context, opts ...grpc.CallOption) (HostGrpc_HostSessionClient, error) {
	stream, err := c.cc.NewStream(ctx, &_HostGrpc_serviceDesc.Streams[0], "/pxr.HostGrpc/HostSession", opts...)
	if err != nil {
		return nil, err
	}
...
func (m *Msg) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.Next != nil {
		{
			...
			i -= size
			i = encodeVarintPxr(dAtA, i, uint64(size))
		}
		i--
		dAtA[i] = 0x2
		i--
	...
	if m.ValInt != 0 {
		i = encodeVarintPxr(dAtA, i, uint64(m.ValInt))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0xb0
	...
	if len(m.ValBuf) > 0 {
		...
		i = encodeVarintPxr(dAtA, i, uint64(len(m.ValBuf)))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0xaa
	...
	if m.ValType != 0 {
		i = encodeVarintPxr(dAtA, i, uint64(m.ValType))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0xa0
	...
	if m.SI != 0 {
		i = encodeVarintPxr(dAtA, i, uint64(m.SI))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0x80
	...
	if m.AttrID != 0 {
		i = encodeVarintPxr(dAtA, i, uint64(m.AttrID))
		i--
		dAtA[i] = 0x78
	}
	if m.FromID != 0 {
		i = encodeVarintPxr(dAtA, i, uint64(m.FromID))
		i--
		dAtA[i] = 0x58
	}
	if m.CellID != 0 {
		i = encodeVarintPxr(dAtA, i, uint64(m.CellID))
		i--
		dAtA[i] = 0x30
	}
	if m.ReqID != 0 {
		i = encodeVarintPxr(dAtA, i, uint64(m.ReqID))
		i--
		dAtA[i] = 0x18
	}
	if m.Op != 0 {
		i = encodeVarintPxr(dAtA, i, uint64(m.Op))
		i--
		dAtA[i] = 0x8
	}
...
func (m *PlanetEpoch) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.CommonName) > 0 {
		...
		i = encodeVarintPxr(dAtA, i, uint64(len(m.CommonName)))
		i--
		dAtA[i] = 0x1a
	}
	...
	if len(m.EpochTID) > 0 {
		...
		i = encodeVarintPxr(dAtA, i, uint64(len(m.EpochTID)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *UserSeat) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	if m.HomePlanetID != 0 {
		i = encodeVarintPxr(dAtA, i, uint64(m.HomePlanetID))
		i--
		dAtA[i] = 0x20
	}
	if m.UserID != 0 {
		i = encodeVarintPxr(dAtA, i, uint64(m.UserID))
		i--
		dAtA[i] = 0x10
	}
	return len(dAtA) - i, nil
...
func (m *LoginReq) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.UserUID) > 0 {
		...
		i = encodeVarintPxr(dAtA, i, uint64(len(m.UserUID)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *Symbol) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Value) > 0 {
		i -= len(m.Value)
		copy(dAtA[i:], m.Value)
		i = encodeVarintPxr(dAtA, i, uint64(len(m.Value)))
		i--
		dAtA[i] = 0x12
	}
	if m.ID != 0 {
		i = encodeVarintPxr(dAtA, i, uint64(m.ID))
		i--
		dAtA[i] = 0x8
	}
	return len(dAtA) - i, nil
...
func (m *AttrSchema) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.SchemaID != 0 {
		i = encodeVarintPxr(dAtA, i, uint64(m.SchemaID))
		i--
		dAtA[i] = 0x30
	}
	if len(m.SchemaName) > 0 {
		...
		i = encodeVarintPxr(dAtA, i, uint64(len(m.SchemaName)))
		i--
		dAtA[i] = 0x22
	}
	if len(m.DataModelURI) > 0 {
		...
		i = encodeVarintPxr(dAtA, i, uint64(len(m.DataModelURI)))
		i--
		dAtA[i] = 0x1a
	}
	if len(m.AppURI) > 0 {
		...
		i = encodeVarintPxr(dAtA, i, uint64(len(m.AppURI)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *AttrSpec) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.ValTypeURI) > 0 {
		...
		i = encodeVarintPxr(dAtA, i, uint64(len(m.ValTypeURI)))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0xb2
	...
	if m.Fixed_SI != 0 {
		i = encodeVarintPxr(dAtA, i, uint64(m.Fixed_SI))
		i--
		dAtA[i] = 0x38
	}
	if m.SeriesType != 0 {
		i = encodeVarintPxr(dAtA, i, uint64(m.SeriesType))
		i--
		dAtA[i] = 0x30
	}
	if m.AttrID != 0 {
	...
	if len(m.AttrURI) > 0 {
		...
		i = encodeVarintPxr(dAtA, i, uint64(len(m.AttrURI)))
		i--
		dAtA[i] = 0x12
	}
	return len(dAtA) - i, nil
...
func (m *PinReq) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.ChildSchemas) > 0 {
		...
		i = encodeVarintPxr(dAtA, i, uint64(j2))
		i--
		dAtA[i] = 0x4a
	}
	if m.PinCellSchema != 0 {
		i = encodeVarintPxr(dAtA, i, uint64(m.PinCellSchema))
		i--
		dAtA[i] = 0x38
	}
	if m.PinCell != 0 {
		i = encodeVarintPxr(dAtA, i, uint64(m.PinCell))
		i--
		dAtA[i] = 0x28
	}
	if len(m.PinURI) > 0 {
		...
		i = encodeVarintPxr(dAtA, i, uint64(len(m.PinURI)))
		i--
		dAtA[i] = 0x1a
	}
	if m.ParentReqID != 0 {
		i = encodeVarintPxr(dAtA, i, uint64(m.ParentReqID))
		i--
		dAtA[i] = 0x8
	}
	return len(dAtA) - i, nil
...
func (m *AttrRange) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.SI_BatchLimit != 0 {
		i = encodeVarintPxr(dAtA, i, uint64(m.SI_BatchLimit))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0xd8
	...
	if m.SI_StopAt != 0 {
		i = encodeVarintPxr(dAtA, i, uint64(m.SI_StopAt))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0xc8
	...
	if m.SI_SeekTo != 0 {
		i = encodeVarintPxr(dAtA, i, uint64(m.SI_SeekTo))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0xc0
...
func (m *GeoFix) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.Model != 0 {
		i = encodeVarintPxr(dAtA, i, uint64(m.Model))
		i--
		dAtA[i] = 0x8
	}
	return len(dAtA) - i, nil
...
func (m *Content) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.LinksCellID != 0 {
		i = encodeVarintPxr(dAtA, i, uint64(m.LinksCellID))
		i--
		dAtA[i] = 0x50
	}
	if m.ContentTypeID != 0 {
		i = encodeVarintPxr(dAtA, i, uint64(m.ContentTypeID))
		i--
		dAtA[i] = 0x28
	}
	if len(m.ContentType) > 0 {
		...
		i = encodeVarintPxr(dAtA, i, uint64(len(m.ContentType)))
		i--
		dAtA[i] = 0x22
	}
	if len(m.ContentData) > 0 {
		...
		i = encodeVarintPxr(dAtA, i, uint64(len(m.ContentData)))
		i--
		dAtA[i] = 0x1a
	}
	return len(dAtA) - i, nil
...
func (m *CryptoKey) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.KeyBytes) > 0 {
		...
		i = encodeVarintPxr(dAtA, i, uint64(len(m.KeyBytes)))
		i--
		dAtA[i] = 0x22
	}
	if m.CryptoKitID != 0 {
		i = encodeVarintPxr(dAtA, i, uint64(m.CryptoKitID))
		i--
		dAtA[i] = 0x8
	}
	return len(dAtA) - i, nil
...
func (m *Link) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.CellType != 0 {
		i = encodeVarintPxr(dAtA, i, uint64(m.CellType))
		i--
		dAtA[i] = 0x20
	}
	if m.CellID != 0 {
	...
	if m.PlanetID != 0 {
		i = encodeVarintPxr(dAtA, i, uint64(m.PlanetID))
		i--
		dAtA[i] = 0x10
	}
	if len(m.URL) > 0 {
		i -= len(m.URL)
		copy(dAtA[i:], m.URL)
		i = encodeVarintPxr(dAtA, i, uint64(len(m.URL)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *TRS) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.ScaleMode != 0 {
		i = encodeVarintPxr(dAtA, i, uint64(m.ScaleMode))
		i--
		dAtA[i] = 0x3
		i--
		dAtA[i] = 0x90
...
func (m *DataSegment) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	if m.BlobID != 0 {
		i = encodeVarintPxr(dAtA, i, uint64(m.BlobID))
		i--
		dAtA[i] = 0x50
	}
	if len(m.StreamURI) > 0 {
		...
		i = encodeVarintPxr(dAtA, i, uint64(len(m.StreamURI)))
		i--
		dAtA[i] = 0x4a
	}
	if len(m.InlineData) > 0 {
		...
		i = encodeVarintPxr(dAtA, i, uint64(len(m.InlineData)))
		i--
		dAtA[i] = 0x3a
	}
	if m.ByteSz != 0 {
		i = encodeVarintPxr(dAtA, i, uint64(m.ByteSz))
		i--
		dAtA[i] = 0x30
	}
	if m.ByteOfs != 0 {
		i = encodeVarintPxr(dAtA, i, uint64(m.ByteOfs))
		i--
		dAtA[i] = 0x28
	}
	return len(dAtA) - i, nil
...
func (m *Err) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Msg) > 0 {
		i -= len(m.Msg)
		copy(dAtA[i:], m.Msg)
		i = encodeVarintPxr(dAtA, i, uint64(len(m.Msg)))
		i--
		dAtA[i] = 0x12
	}
	if m.Code != 0 {
		i = encodeVarintPxr(dAtA, i, uint64(m.Code))
		i--
		dAtA[i] = 0x8
	}
	return len(dAtA) - i, nil
...
func encodeVarintPxr(dAtA []byte, offset int, v uint64) int {
	offset -= sovPxr(v)
	base := offset
	for v >= 1<<7 {
...
func (m *Msg) Size() (n int) {
	...
	_ = l
	if m.Op != 0 {
		n += 1 + sovPxr(uint64(m.Op))
	}
	if m.ReqID != 0 {
		n += 1 + sovPxr(uint64(m.ReqID))
	}
	if m.CellID != 0 {
		n += 1 + sovPxr(uint64(m.CellID))
	}
	if m.FromID != 0 {
		n += 1 + sovPxr(uint64(m.FromID))
	}
	if m.AttrID != 0 {
		n += 1 + sovPxr(uint64(m.AttrID))
	}
	if m.SI != 0 {
		n += 2 + sovPxr(uint64(m.SI))
	}
	if m.ValType != 0 {
		n += 2 + sovPxr(uint64(m.ValType))
	}
	l = len(m.ValBuf)
	if l > 0 {
		n += 2 + l + sovPxr(uint64(l))
	}
	if m.ValInt != 0 {
		n += 2 + sovPxr(uint64(m.ValInt))
	}
	if m.ValFloat != 0 {
		n += 10
	}
...
func (m *UserSeat) Size() (n int) {
	...
	_ = l
	if m.UserID != 0 {
		n += 1 + sovPxr(uint64(m.UserID))
	}
	if m.HomePlanetID != 0 {
		n += 1 + sovPxr(uint64(m.HomePlanetID))
	}
	return n
}
...
func (m *AttrSpec) Size() (n int) {
	...
	if m.SeriesType != 0 {
		n += 1 + sovPxr(uint64(m.SeriesType))
	}
	if m.Fixed_SI != 0 {
		n += 1 + sovPxr(uint64(m.Fixed_SI))
	}
	l = len(m.ValTypeURI)
	if l > 0 {
		n += 2 + l + sovPxr(uint64(l))
...
func (m *PinReq) Size() (n int) {
	...
	_ = l
	if m.ParentReqID != 0 {
		n += 1 + sovPxr(uint64(m.ParentReqID))
	}
	l = len(m.PinURI)
	if l > 0 {
		n += 1 + l + sovPxr(uint64(l))
	...
	if m.PinCell != 0 {
		n += 1 + sovPxr(uint64(m.PinCell))
	}
	if m.PinCellSchema != 0 {
		n += 1 + sovPxr(uint64(m.PinCellSchema))
	}
	if len(m.ChildSchemas) > 0 {
		l = 0
...
func (m *AttrRange) Size() (n int) {
	...
	_ = l
	if m.SI_SeekTo != 0 {
		n += 2 + sovPxr(uint64(m.SI_SeekTo))
	}
	if m.SI_StopAt != 0 {
		n += 2 + sovPxr(uint64(m.SI_StopAt))
	}
	if m.SI_BatchLimit != 0 {
		n += 2 + sovPxr(uint64(m.SI_BatchLimit))
	}
	return n
}
...
func (m *Content) Size() (n int) {
	...
	if m.ContentTypeID != 0 {
		n += 1 + sovPxr(uint64(m.ContentTypeID))
	}
	if m.LinksCellID != 0 {
		n += 1 + sovPxr(uint64(m.LinksCellID))
	}
	if m.Location != nil {
		l = m.Location.Size()
		n += 1 + l + sovPxr(uint64(l))
...
func (m *CryptoKey) Size() (n int) {
	...
	_ = l
	if m.CryptoKitID != 0 {
		n += 1 + sovPxr(uint64(m.CryptoKitID))
	}
	l = len(m.KeyBytes)
	if l > 0 {
		n += 1 + l + sovPxr(uint64(l))
...
func (m *Link) Size() (n int) {
	...
	if m.PlanetID != 0 {
		n += 1 + sovPxr(uint64(m.PlanetID))
	}
	if m.CellID != 0 {
		n += 1 + sovPxr(uint64(m.CellID))
	}
	if m.CellType != 0 {
		n += 1 + sovPxr(uint64(m.CellType))
	}
	if m.ListOrder != 0 {
		n += 9
	}
...
func (m *DataSegment) Size() (n int) {
	...
	_ = l
	if m.ByteOfs != 0 {
		n += 1 + sovPxr(uint64(m.ByteOfs))
	}
	if m.ByteSz != 0 {
		n += 1 + sovPxr(uint64(m.ByteSz))
	}
	l = len(m.InlineData)
	if l > 0 {
		n += 1 + l + sovPxr(uint64(l))
...
func sovPxr(x uint64) (n int) {
	return (math_bits.Len64(x|1) + 6) / 7
}
func sozPxr(x uint64) (n int) {
	return sovPxr(uint64((x << 1) ^ uint64((int64(x) >> 63))))
}
...
func (this *PinReq) String() string {
	...
	s := strings.Join([]string{`&PinReq{`,
		...
		`PinCellSchema:` + fmt.Sprintf("%v", this.PinCellSchema) + `,`,
...
func valueToStringPxr(v interface{}) string {
	rv := reflect.ValueOf(v)
	if rv.IsNil() {
		return "nil"
	}
...
func (m *PinReq) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 7:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field PinCellSchema", wireType)
			}
			m.PinCellSchema = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.PinCellSchema |= int32(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func skipPxr(dAtA []byte) (n int, err error) {
	l := len(dAtA)
	iNdEx := 0
	depth := 0
	for iNdEx < l {
		...
		case 4:
			if depth == 0 {
				return 0, ErrUnexpectedEndOfGroupPxr
			}
			depth--
		case 5:
			iNdEx += 4
...
var (
	ErrInvalidLengthPxr        = fmt.Errorf("proto: negative length found during unmarshaling")
	ErrIntOverflowPxr          = fmt.Errorf("proto: integer overflow")
	ErrUnexpectedEndOfGroupPxr = fmt.Errorf("proto: unexpected end of group")
)
