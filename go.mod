module github.com/amp-space/amp-host-go

go 1.18

// List versions of a module:
//    go list -m -versions -json github.com/amp-space/amp-sdk-go
//
...
// replace github.com/amp-space/amp-librespot-go => ../librespot-go

require (
	github.com/alecthomas/participle/v2 v2.1.1
	github.com/amp-space/amp-librespot-go v0.0.0-20240406231448-eeb90dd8743f
