...
// planet specifies an implementation-independent API and support for a distributed
...
func (Const) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_100f8d53602fc3e1, []int{0}
}
...
const (
	...
	// Primitive (atomic) literals
	//ValType_Delete             = 1; // Denotes item deletion
	ValType_int    ValType = 4
	ValType_float  ValType = 5
	ValType_bytes  ValType = 6
	ValType_string ValType = 7
	// Primitive internal types (not generally exposed to at the app level)
	ValType_TID      ValType = 16
	ValType_LoginReq ValType = 20
	ValType_SchemaID ValType = 21
	...
	// Protobuf (atomic) literals
	ValType_Err         ValType = 34
	ValType_AttrRange   ValType = 39
	ValType_PinReq      ValType = 40
	ValType_CryptoKey   ValType = 41
	ValType_Link        ValType = 42
	ValType_Defs        ValType = 43
	ValType_Content     ValType = 44
	ValType_DataSegment ValType = 45
	ValType_Txn         ValType = 50
	ValType_GeoFix      ValType = 46
	ValType_TRS         ValType = 47
	ValType_LiteralMax  ValType = 299
)
...
var ValType_name = map[int32]string{
	...
	26:  "ValType_URL",
	34:  "ValType_Err",
	39:  "ValType_AttrRange",
	40:  "ValType_PinReq",
	41:  "ValType_CryptoKey",
	42:  "ValType_Link",
	43:  "ValType_Defs",
	44:  "ValType_Content",
	45:  "ValType_DataSegment",
	50:  "ValType_Txn",
	46:  "ValType_GeoFix",
	47:  "ValType_TRS",
	299: "ValType_LiteralMax",
}
...
var ValType_value = map[string]int32{
	...
	"ValType_URL":         26,
	"ValType_Err":         34,
	"ValType_AttrRange":   39,
	"ValType_PinReq":      40,
	"ValType_CryptoKey":   41,
	"ValType_Link":        42,
	"ValType_Defs":        43,
	"ValType_Content":     44,
	"ValType_DataSegment": 45,
	"ValType_Txn":         50,
	"ValType_GeoFix":      46,
	"ValType_TRS":         47,
	"ValType_LiteralMax":  299,
}

func (ValType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_100f8d53602fc3e1, []int{1}
}
...
const (
	...
	//
	// Params:
	//      Msg.ReqID:        newly client-generated (unique) request ID
	//      Msg.ValType:      ValType_Defs
	//      Msg.ValBuf:       Defs (serialized)
	MsgOp_ResolveAndRegister MsgOp = 5
	// A client request for a given CellID to be pinned under a client-generated "pin" ID.
	// Note that the same cell pinned multiple times may not have child cells with matching cell IDs.
	//
	// Params:
	//      Msg.ParentReqID:  parent of cell to be pinned
	//      Msg.ReqID:        newly client-generated (unique) request ID
	//      Msg.TargetCellID: which cell to be pinned
	//      Msg.ValType:      ValType_PinReq
	//      Msg.ValBuf:       req params
	...
	//      Msg.TargetCellID: which cell is being updated
	//      Msg.AttrID:       which attr is being updated
	//      Msg.ValType:      format of Msg.ValInt / .ValFloat / .ValBuf
	//      Msg.Val*:         attr value
	MsgOp_PushAttr MsgOp = 10
	// Signals the addition of a new child cell of a given pinned cell (with MsgOp_PushAttr and MsgOp_Checkpoint to follow).
	//
	// Params:
	//      Msg.ReqID:        originating request ID
	//      Msg.ParentCellID: parent cell of the child cell being pushed
	//      Msg.TargetCellID: new cell ID of the child cell being pushed
	//      Msg.ValType:      ValType_SchemaID
	//      Msg.ValInt:       cell type ID being pushed (specifies which Cell attribs are expected to follow)
	MsgOp_InsertChildCell MsgOp = 11
	...
	// Params:
	//      Msg.ReqID:        originating request ID
	//      Msg.TargetCellID: which cell is an an updated state
...
var MsgOp_value = map[string]int32{
	...
	"MsgOp_PinCell":            6,
	"MsgOp_PushAttr":           10,
	"MsgOp_InsertChildCell":    11,
	"MsgOp_Commit":             24,
	"MsgOp_CloseReq":           255,
}

func (MsgOp) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_100f8d53602fc3e1, []int{2}
}
...
const (
	...
	SeriesType_NameSet SeriesType = 10
	SeriesType_CellSet SeriesType = 11
)
...
var SeriesType_name = map[int32]string{
	...
	5:  "SeriesType_Time16",
	6:  "SeriesType_UTC16",
	10: "SeriesType_NameSet",
	11: "SeriesType_CellSet",
}
...
func (SeriesType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_100f8d53602fc3e1, []int{3}
}
...
func (GeoModel) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_100f8d53602fc3e1, []int{4}
}
...
func (CryptoKitID) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_100f8d53602fc3e1, []int{5}
}
...
const (
	...
	ErrCode_CellNotFound            ErrCode = 5055
...
func (ErrCode) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_100f8d53602fc3e1, []int{6}
}
...
func (TRS_VisualScaleMode) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_100f8d53602fc3e1, []int{14, 0}
}

type Msg struct {
	// Describes how this Msg should be interpreted
	Op MsgOp `protobuf:"varint,1,opt,name=Op,proto3,enum=planet.MsgOp" json:"Op,omitempty"`
	...
	// ParentReqID specifies the parent request ID of this ReqID and provides context that TargetCellID cannot provide.
	// If 0, this denotes that this Msg is a response to the request to the given ReqID.
	ParentReqID uint64 `protobuf:"varint,5,opt,name=ParentReqID,proto3" json:"ParentReqID,omitempty"`
	// TargetCellID identifies the cell associated with this MsgOp.
	//
	// When child cells are being pushed, they may or may not have persistent TargetCellIDs,
	// so never assume any two matching or non-matching TargetCellIDs are the same cell (unless they have the same ParentCellID).
	TargetCellID uint64 `protobuf:"varint,6,opt,name=TargetCellID,proto3" json:"TargetCellID,omitempty"`
	FromID       uint64 `protobuf:"varint,11,opt,name=FromID,proto3" json:"FromID,omitempty"`
	AttrID       uint32 `protobuf:"varint,15,opt,name=AttrID,proto3" json:"AttrID,omitempty"`
	...
	// ValType how to interpret ValBuf, ValInt, and ValFloat
	ValType uint64 `protobuf:"varint,20,opt,name=ValType,proto3" json:"ValType,omitempty"`
	// Value / payload data
	...
	ValFloat float64 `protobuf:"fixed64,23,opt,name=ValFloat,proto3" json:"ValFloat,omitempty"`
	// ValBufIsShared signals that Msg.ValBuf is referenced elsewhere and is READ ONLY.
	// This is intended to be used internally for Msg pooling / recycling, so when marshaling, this value is cleared.
	ValBufIsShared bool `protobuf:"varint,31,opt,name=ValBufIsShared,proto3" json:"ValBufIsShared,omitempty"`
...
func (m *Msg) GetParentReqID() uint64 {
	if m != nil {
...
func (m *Msg) GetTargetCellID() uint64 {
	if m != nil {
...
func (m *Msg) GetValFloat() float64 {
	if m != nil {
		return m.ValFloat
	}
	return 0
...
func (m *Msg) GetValBufIsShared() bool {
	if m != nil {
		return m.ValBufIsShared
	}
	return false
}
...
type AttrSchema struct {
	// AppURI specifies which app should handle this request.
	// If omitted, the default or otherwise best app is chosen based on DataModelURI.
	// e.g. "genesis3.systems/vibe.app/v1"
	AppURI string `protobuf:"bytes,1,opt,name=AppURI,proto3" json:"AppURI,omitempty"`
	// DataModelURI names a particular data model used by this schema, in effect specifying a namespace / scope for the attached Attrs.
	// This URI names a complete data model / specification that this collection of AttrSpecs conforms to (and is a subset of).
	...
	//      "hfs1/directory"
	//      "hfs1/fstat"
	DataModelURI string `protobuf:"bytes,3,opt,name=DataModelURI,proto3" json:"DataModelURI,omitempty"`
	// SchemaURI names *this* particular collection of AttrSpecs, and is implicitly scoped within the given DataModelURI.
	// Typically, a UI Cell view specifies a unique SchemaURI for the set of attrs it wants to display, meaning this field tends to correspond to a particular "view" of a data model instance.
	// e.g. for DataModelURI == "spotify/v1/album":
	//      "ux1/item.1x1.cell"
	//      "ux1/item.row.cell"
	//      "ux1/detailed.row.cell"
	SchemaURI string `protobuf:"bytes,4,opt,name=SchemaURI,proto3" json:"SchemaURI,omitempty"`
	// SchemaID is a non-zero, unique, client-generated ID that is bound to this AttrSchema during RegisterAndResolve.
	// This ID is used in PinReq to specify this AttrSchema and persists for the duration of the host session.
	SchemaID uint32 `protobuf:"varint,6,opt,name=SchemaID,proto3" json:"SchemaID,omitempty"`
	// The set of AttrSpecs bound to this SchemaURI.
...
func (m *AttrSchema) GetDataModelURI() string {
	if m != nil {
		return m.DataModelURI
	}
	return ""
}

func (m *AttrSchema) GetSchemaURI() string {
	if m != nil {
		return m.SchemaURI
	}
	return ""
...
func (m *AttrSchema) GetSchemaID() uint32 {
	if m != nil {
		return m.SchemaID
	}
	return 0
...
type AttrSpec struct {
	// AttrURI is a self-describing URI scoped within the parent's DataModelURI.
	...
	// e.g. for AttrSchema.DataModelURI == "hfs1/directory"
	//      "v1/creation-time"
	//      "v1/thumbnail.glyph"
	//      "v1/detailed.glyph"
	//      "v1/name"
	//      "v1/status"
	//      "v1/item-count"
	AttrURI string `protobuf:"bytes,1,opt,name=AttrURI,proto3" json:"AttrURI,omitempty"`
	...
	AttrID uint32 `protobuf:"varint,4,opt,name=AttrID,proto3" json:"AttrID,omitempty"`
	...
	SeriesType SeriesType `protobuf:"varint,6,opt,name=SeriesType,proto3,enum=planet.SeriesType" json:"SeriesType,omitempty"`
	// Fixed_SI specifies which SI value this fixed attr is "hard-wired" to, meaning that a PushAttr Msg has its SI field set to this value.
	// Only used / applicable when SeriesType == SeriesType_Fixed.
	Fixed_SI int64 `protobuf:"varint,7,opt,name=Fixed_SI,json=FixedSI,proto3" json:"Fixed_SI,omitempty"`
	// Specifies the attr item / element value type (this is what shows up in Msg.ValType)
	// Can be any primitive, pb literal, or attr set scheme (i.e. "Cell")..
	ValTypeURI string `protobuf:"bytes,22,opt,name=ValTypeURI,proto3" json:"ValTypeURI,omitempty"`
}

func (m *AttrSpec) Reset()      { *m = AttrSpec{} }
func (*AttrSpec) ProtoMessage() {}
func (*AttrSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_100f8d53602fc3e1, []int{7}
}
...
func (m *AttrSpec) GetAttrID() uint32 {
	if m != nil {
		return m.AttrID
	}
	return 0
...
func (m *AttrSpec) GetFixed_SI() int64 {
	if m != nil {
		return m.Fixed_SI
	}
	return 0
...
func (m *AttrSpec) GetValTypeURI() string {
	if m != nil {
		return m.ValTypeURI
	}
	return ""
...
type PinReq struct {
	// Specifies which cell is to be pinned
	// This is typically omitted since the given SchemaID + CellID imply which cell is being pinned.
	CellURI string `protobuf:"bytes,2,opt,name=CellURI,proto3" json:"CellURI,omitempty"`
	// SchemaID specifies an AttrSchema, implying which attrs of the pinned cell are to be pushed to the client.
	SchemaID uint32 `protobuf:"varint,3,opt,name=SchemaID,proto3" json:"SchemaID,omitempty"`
	// ChildSchemas specifies which child cell types should be pushed (and which attr schema they should be pushed with).
	// If empty, no child cells are pushed.
	ChildSchemas []uint32 `protobuf:"varint,4,rep,packed,name=ChildSchemas,proto3" json:"ChildSchemas,omitempty"`
}

func (m *PinReq) Reset()      { *m = PinReq{} }
func (*PinReq) ProtoMessage() {}
func (*PinReq) Descriptor() ([]byte, []int) {
	return fileDescriptor_100f8d53602fc3e1, []int{8}
}
...
func (m *PinReq) GetCellURI() string {
	if m != nil {
		return m.CellURI
	}
	return ""
...
func (m *PinReq) GetSchemaID() uint32 {
	if m != nil {
		return m.SchemaID
	}
	return 0
...
func (m *PinReq) GetChildSchemas() []uint32 {
	if m != nil {
...
func (*AttrRange) Descriptor() ([]byte, []int) {
	return fileDescriptor_100f8d53602fc3e1, []int{9}
}
...
type GeoFix struct {
	Model  GeoModel `protobuf:"varint,1,opt,name=Model,proto3,enum=planet.GeoModel" json:"Model,omitempty"`
...
func (*GeoFix) Descriptor() ([]byte, []int) {
	return fileDescriptor_100f8d53602fc3e1, []int{10}
}
...
func (*Content) Descriptor() ([]byte, []int) {
	return fileDescriptor_100f8d53602fc3e1, []int{11}
}
...
type CryptoKey struct {
	CryptoKitID CryptoKitID `protobuf:"varint,1,opt,name=CryptoKitID,proto3,enum=planet.CryptoKitID" json:"CryptoKitID,omitempty"`
...
func (*CryptoKey) Descriptor() ([]byte, []int) {
	return fileDescriptor_100f8d53602fc3e1, []int{12}
}
...
type Link struct {
	...
	PlanetID  int64   `protobuf:"varint,2,opt,name=PlanetID,proto3" json:"PlanetID,omitempty"`
	CellID    int64   `protobuf:"varint,3,opt,name=CellID,proto3" json:"CellID,omitempty"`
	CellType  int64   `protobuf:"varint,4,opt,name=CellType,proto3" json:"CellType,omitempty"`
	ListOrder float64 `protobuf:"fixed64,6,opt,name=ListOrder,proto3" json:"ListOrder,omitempty"`
}

func (m *Link) Reset()      { *m = Link{} }
func (*Link) ProtoMessage() {}
func (*Link) Descriptor() ([]byte, []int) {
	return fileDescriptor_100f8d53602fc3e1, []int{13}
}
...
func (m *Link) GetListOrder() float64 {
	if m != nil {
		return m.ListOrder
	}
	return 0
...
type TRS struct {
	...
	ScaleMode TRS_VisualScaleMode `protobuf:"varint,50,opt,name=ScaleMode,proto3,enum=planet.TRS_VisualScaleMode" json:"ScaleMode,omitempty"`
...
func (*TRS) Descriptor() ([]byte, []int) {
	return fileDescriptor_100f8d53602fc3e1, []int{14}
}
...
func (*FeedParams) Descriptor() ([]byte, []int) {
	return fileDescriptor_100f8d53602fc3e1, []int{15}
}
...
func (*DataSegment) Descriptor() ([]byte, []int) {
	return fileDescriptor_100f8d53602fc3e1, []int{16}
}
...
type Err struct {
	...
	Code ErrCode `protobuf:"varint,1,opt,name=Code,proto3,enum=planet.ErrCode" json:"Code,omitempty"`
...
func (*Err) Descriptor() ([]byte, []int) {
	return fileDescriptor_100f8d53602fc3e1, []int{17}
}
...
func init() {
	proto.RegisterEnum("planet.Const", Const_name, Const_value)
	proto.RegisterEnum("planet.ValType", ValType_name, ValType_value)
	proto.RegisterEnum("planet.MsgOp", MsgOp_name, MsgOp_value)
	proto.RegisterEnum("planet.SeriesType", SeriesType_name, SeriesType_value)
	proto.RegisterEnum("planet.GeoModel", GeoModel_name, GeoModel_value)
	proto.RegisterEnum("planet.CryptoKitID", CryptoKitID_name, CryptoKitID_value)
	proto.RegisterEnum("planet.ErrCode", ErrCode_name, ErrCode_value)
	proto.RegisterEnum("planet.TRS_VisualScaleMode", TRS_VisualScaleMode_name, TRS_VisualScaleMode_value)
	proto.RegisterType((*Msg)(nil), "planet.Msg")
	proto.RegisterType((*PlanetEpoch)(nil), "planet.PlanetEpoch")
	proto.RegisterType((*UserSeat)(nil), "planet.UserSeat")
	proto.RegisterType((*LoginReq)(nil), "planet.LoginReq")
	proto.RegisterType((*Symbol)(nil), "planet.Symbol")
	proto.RegisterType((*Defs)(nil), "planet.Defs")
	proto.RegisterType((*AttrSchema)(nil), "planet.AttrSchema")
	proto.RegisterType((*AttrSpec)(nil), "planet.AttrSpec")
	proto.RegisterType((*PinReq)(nil), "planet.PinReq")
	proto.RegisterType((*AttrRange)(nil), "planet.AttrRange")
	proto.RegisterType((*GeoFix)(nil), "planet.GeoFix")
	proto.RegisterType((*Content)(nil), "planet.Content")
	proto.RegisterType((*CryptoKey)(nil), "planet.CryptoKey")
	proto.RegisterType((*Link)(nil), "planet.Link")
	proto.RegisterType((*TRS)(nil), "planet.TRS")
	proto.RegisterType((*FeedParams)(nil), "planet.FeedParams")
	proto.RegisterType((*DataSegment)(nil), "planet.DataSegment")
	proto.RegisterType((*Err)(nil), "planet.Err")
}

func init() { proto.RegisterFile("planet/planet.proto", fileDescriptor_100f8d53602fc3e1) }

var fileDescriptor_100f8d53602fc3e1 = []byte{
	// 2213 bytes of a gzipped FileDescriptorProto
	,
}
...
func (this *Msg) Equal(that interface{}) bool {
	...
	if this.ValFloat != that1.ValFloat {
		return false
	}
	if this.ValBufIsShared != that1.ValBufIsShared {
		return false
	}
...
func (this *AttrSchema) Equal(that interface{}) bool {
	...
	if this.DataModelURI != that1.DataModelURI {
		return false
	}
	if this.SchemaURI != that1.SchemaURI {
		return false
	}
...
func (this *AttrSpec) Equal(that interface{}) bool {
	...
	if this.Fixed_SI != that1.Fixed_SI {
		return false
	}
	if this.ValTypeURI != that1.ValTypeURI {
		return false
	}
	return true
}
...
func (this *Link) Equal(that interface{}) bool {
	...
	if this.PlanetID != that1.PlanetID {
		return false
	}
	if this.CellID != that1.CellID {
		return false
	}
	if this.CellType != that1.CellType {
		return false
	}
	if this.ListOrder != that1.ListOrder {
		return false
	}
	return true
}
...
func (this *Msg) GoString() string {
	...
	s = append(s, "ValFloat: "+fmt.Sprintf("%#v", this.ValFloat)+",\n")
	s = append(s, "ValBufIsShared: "+fmt.Sprintf("%#v", this.ValBufIsShared)+",\n")
	if this.Next != nil {
...
func (this *AttrSchema) GoString() string {
	...
	s := make([]string, 0, 9)
	s = append(s, "&planet.AttrSchema{")
	s = append(s, "AppURI: "+fmt.Sprintf("%#v", this.AppURI)+",\n")
	s = append(s, "DataModelURI: "+fmt.Sprintf("%#v", this.DataModelURI)+",\n")
	s = append(s, "SchemaURI: "+fmt.Sprintf("%#v", this.SchemaURI)+",\n")
...
func (this *AttrSpec) GoString() string {
	...
	s := make([]string, 0, 9)
	s = append(s, "&planet.AttrSpec{")
	s = append(s, "AttrURI: "+fmt.Sprintf("%#v", this.AttrURI)+",\n")
	s = append(s, "AttrID: "+fmt.Sprintf("%#v", this.AttrID)+",\n")
	s = append(s, "SeriesType: "+fmt.Sprintf("%#v", this.SeriesType)+",\n")
	s = append(s, "Fixed_SI: "+fmt.Sprintf("%#v", this.Fixed_SI)+",\n")
	s = append(s, "ValTypeURI: "+fmt.Sprintf("%#v", this.ValTypeURI)+",\n")
	s = append(s, "}")
	return strings.Join(s, "")
}
func (this *PinReq) GoString() string {
	...
	s := make([]string, 0, 7)
	s = append(s, "&planet.PinReq{")
	s = append(s, "CellURI: "+fmt.Sprintf("%#v", this.CellURI)+",\n")
	s = append(s, "SchemaID: "+fmt.Sprintf("%#v", this.SchemaID)+",\n")
...
func (this *Link) GoString() string {
	...
	s := make([]string, 0, 9)
	s = append(s, "&planet.Link{")
	s = append(s, "URL: "+fmt.Sprintf("%#v", this.URL)+",\n")
	s = append(s, "PlanetID: "+fmt.Sprintf("%#v", this.PlanetID)+",\n")
	s = append(s, "CellID: "+fmt.Sprintf("%#v", this.CellID)+",\n")
	s = append(s, "CellType: "+fmt.Sprintf("%#v", this.CellType)+",\n")
	s = append(s, "ListOrder: "+fmt.Sprintf("%#v", this.ListOrder)+",\n")
	s = append(s, "}")
	return strings.Join(s, "")
}
...
func (this *Err) GoString() string {
	...
	s := make([]string, 0, 6)
	s = append(s, "&planet.Err{")
	s = append(s, "Code: "+fmt.Sprintf("%#v", this.Code)+",\n")
	s = append(s, "Msg: "+fmt.Sprintf("%#v", this.Msg)+",\n")
	s = append(s, "}")
	return strings.Join(s, "")
}
func valueToGoStringPlanet(v interface{}, typ string) string {
...
func (c *hostGrpcClient) HostSession(ctx context.Context, opts ...grpc.CallOption) (HostGrpc_HostSessionClient, error) {
	stream, err := c.cc.NewStream(ctx, &_HostGrpc_serviceDesc.Streams[0], "/planet.HostGrpc/HostSession", opts...)
	if err != nil {
		return nil, err
	}
...
func (m *Msg) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.ValFloat != 0 {
		i -= 8
		encoding_binary.LittleEndian.PutUint64(dAtA[i:], uint64(math.Float64bits(float64(m.ValFloat))))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0xb9
	...
	if m.ValInt != 0 {
		i = encodeVarintPlanet(dAtA, i, uint64(m.ValInt))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0xb0
	...
	if len(m.ValBuf) > 0 {
		...
		i = encodeVarintPlanet(dAtA, i, uint64(len(m.ValBuf)))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0xaa
	...
	if m.ValType != 0 {
		i = encodeVarintPlanet(dAtA, i, uint64(m.ValType))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0xa0
	...
	if m.SI != 0 {
		i = encodeVarintPlanet(dAtA, i, uint64(m.SI))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0x80
	...
	if m.AttrID != 0 {
		i = encodeVarintPlanet(dAtA, i, uint64(m.AttrID))
		i--
		dAtA[i] = 0x78
	}
	if m.FromID != 0 {
		i = encodeVarintPlanet(dAtA, i, uint64(m.FromID))
		i--
		dAtA[i] = 0x58
	}
	if m.TargetCellID != 0 {
		i = encodeVarintPlanet(dAtA, i, uint64(m.TargetCellID))
		i--
		dAtA[i] = 0x30
	}
	if m.ParentReqID != 0 {
		i = encodeVarintPlanet(dAtA, i, uint64(m.ParentReqID))
		i--
		dAtA[i] = 0x28
	}
	if m.ReqID != 0 {
		i = encodeVarintPlanet(dAtA, i, uint64(m.ReqID))
		i--
		dAtA[i] = 0x18
	}
	if m.Op != 0 {
		i = encodeVarintPlanet(dAtA, i, uint64(m.Op))
		i--
		dAtA[i] = 0x8
	}
...
func (m *PlanetEpoch) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.CommonName) > 0 {
		...
		i = encodeVarintPlanet(dAtA, i, uint64(len(m.CommonName)))
		i--
		dAtA[i] = 0x1a
	}
	...
	if len(m.EpochTID) > 0 {
		...
		i = encodeVarintPlanet(dAtA, i, uint64(len(m.EpochTID)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *UserSeat) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	if m.HomePlanetID != 0 {
		i = encodeVarintPlanet(dAtA, i, uint64(m.HomePlanetID))
		i--
		dAtA[i] = 0x20
	}
	if m.UserID != 0 {
		i = encodeVarintPlanet(dAtA, i, uint64(m.UserID))
		i--
		dAtA[i] = 0x10
	}
	return len(dAtA) - i, nil
...
func (m *LoginReq) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.UserUID) > 0 {
		...
		i = encodeVarintPlanet(dAtA, i, uint64(len(m.UserUID)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *Symbol) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Value) > 0 {
		i -= len(m.Value)
		copy(dAtA[i:], m.Value)
		i = encodeVarintPlanet(dAtA, i, uint64(len(m.Value)))
		i--
		dAtA[i] = 0x12
	}
	if m.ID != 0 {
...
func (m *AttrSchema) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.SchemaID != 0 {
		i = encodeVarintPlanet(dAtA, i, uint64(m.SchemaID))
		i--
		dAtA[i] = 0x30
	}
	if len(m.SchemaURI) > 0 {
		...
		i = encodeVarintPlanet(dAtA, i, uint64(len(m.SchemaURI)))
		i--
		dAtA[i] = 0x22
	}
	if len(m.DataModelURI) > 0 {
		i -= len(m.DataModelURI)
		copy(dAtA[i:], m.DataModelURI)
		i = encodeVarintPlanet(dAtA, i, uint64(len(m.DataModelURI)))
		i--
		dAtA[i] = 0x1a
	}
	if len(m.AppURI) > 0 {
		...
		i = encodeVarintPlanet(dAtA, i, uint64(len(m.AppURI)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *AttrSpec) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.ValTypeURI) > 0 {
		i -= len(m.ValTypeURI)
		copy(dAtA[i:], m.ValTypeURI)
		i = encodeVarintPlanet(dAtA, i, uint64(len(m.ValTypeURI)))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0xb2
	...
	if m.Fixed_SI != 0 {
		i = encodeVarintPlanet(dAtA, i, uint64(m.Fixed_SI))
		i--
		dAtA[i] = 0x38
	}
	if m.SeriesType != 0 {
		i = encodeVarintPlanet(dAtA, i, uint64(m.SeriesType))
		i--
		dAtA[i] = 0x30
	}
	if m.AttrID != 0 {
	...
	if len(m.AttrURI) > 0 {
		...
		i = encodeVarintPlanet(dAtA, i, uint64(len(m.AttrURI)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *PinReq) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.ChildSchemas) > 0 {
		...
		var j2 int
		for _, num := range m.ChildSchemas {
			for num >= 1<<7 {
		...
		i = encodeVarintPlanet(dAtA, i, uint64(j2))
		i--
		dAtA[i] = 0x22
	}
	if m.SchemaID != 0 {
	...
	if len(m.CellURI) > 0 {
		i -= len(m.CellURI)
		copy(dAtA[i:], m.CellURI)
		i = encodeVarintPlanet(dAtA, i, uint64(len(m.CellURI)))
		i--
		dAtA[i] = 0x12
	}
	return len(dAtA) - i, nil
...
func (m *AttrRange) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.SI_BatchLimit != 0 {
		i = encodeVarintPlanet(dAtA, i, uint64(m.SI_BatchLimit))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0xd8
	...
	if m.SI_StopAt != 0 {
		i = encodeVarintPlanet(dAtA, i, uint64(m.SI_StopAt))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0xc8
	...
	if m.SI_SeekTo != 0 {
		i = encodeVarintPlanet(dAtA, i, uint64(m.SI_SeekTo))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0xc0
...
func (m *GeoFix) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.Model != 0 {
		i = encodeVarintPlanet(dAtA, i, uint64(m.Model))
		i--
		dAtA[i] = 0x8
	}
	return len(dAtA) - i, nil
...
func (m *Content) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.LinksCellID != 0 {
		i = encodeVarintPlanet(dAtA, i, uint64(m.LinksCellID))
		i--
		dAtA[i] = 0x50
	}
	if m.ContentTypeID != 0 {
		i = encodeVarintPlanet(dAtA, i, uint64(m.ContentTypeID))
		i--
		dAtA[i] = 0x28
	}
	if len(m.ContentType) > 0 {
		...
		i = encodeVarintPlanet(dAtA, i, uint64(len(m.ContentType)))
		i--
		dAtA[i] = 0x22
	}
	if len(m.ContentData) > 0 {
		...
		i = encodeVarintPlanet(dAtA, i, uint64(len(m.ContentData)))
		i--
		dAtA[i] = 0x1a
	}
	return len(dAtA) - i, nil
...
func (m *CryptoKey) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.KeyBytes) > 0 {
		...
		i = encodeVarintPlanet(dAtA, i, uint64(len(m.KeyBytes)))
		i--
		dAtA[i] = 0x22
	}
	if m.CryptoKitID != 0 {
		i = encodeVarintPlanet(dAtA, i, uint64(m.CryptoKitID))
		i--
		dAtA[i] = 0x8
	}
	return len(dAtA) - i, nil
...
func (m *Link) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.ListOrder != 0 {
		i -= 8
		encoding_binary.LittleEndian.PutUint64(dAtA[i:], uint64(math.Float64bits(float64(m.ListOrder))))
		i--
		dAtA[i] = 0x31
	}
	if m.CellType != 0 {
		i = encodeVarintPlanet(dAtA, i, uint64(m.CellType))
		i--
		dAtA[i] = 0x20
	}
	if m.CellID != 0 {
		i = encodeVarintPlanet(dAtA, i, uint64(m.CellID))
		i--
		dAtA[i] = 0x18
	}
	if m.PlanetID != 0 {
	...
	if len(m.URL) > 0 {
		i -= len(m.URL)
		copy(dAtA[i:], m.URL)
		i = encodeVarintPlanet(dAtA, i, uint64(len(m.URL)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *TRS) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.ScaleMode != 0 {
		i = encodeVarintPlanet(dAtA, i, uint64(m.ScaleMode))
		i--
		dAtA[i] = 0x3
		i--
		dAtA[i] = 0x90
...
func (m *DataSegment) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	if m.BlobID != 0 {
		i = encodeVarintPlanet(dAtA, i, uint64(m.BlobID))
		i--
		dAtA[i] = 0x50
	}
	if len(m.StreamURI) > 0 {
		...
		i = encodeVarintPlanet(dAtA, i, uint64(len(m.StreamURI)))
		i--
		dAtA[i] = 0x4a
	}
	if len(m.InlineData) > 0 {
		...
		i = encodeVarintPlanet(dAtA, i, uint64(len(m.InlineData)))
		i--
		dAtA[i] = 0x3a
	}
	if m.ByteSz != 0 {
		i = encodeVarintPlanet(dAtA, i, uint64(m.ByteSz))
		i--
		dAtA[i] = 0x30
	}
	if m.ByteOfs != 0 {
		i = encodeVarintPlanet(dAtA, i, uint64(m.ByteOfs))
		i--
		dAtA[i] = 0x28
	}
	return len(dAtA) - i, nil
...
func (m *Err) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Msg) > 0 {
		i -= len(m.Msg)
		copy(dAtA[i:], m.Msg)
		i = encodeVarintPlanet(dAtA, i, uint64(len(m.Msg)))
		i--
		dAtA[i] = 0x12
	}
	if m.Code != 0 {
		i = encodeVarintPlanet(dAtA, i, uint64(m.Code))
		i--
		dAtA[i] = 0x8
	}
	return len(dAtA) - i, nil
...
func (m *Msg) Size() (n int) {
	...
	_ = l
	if m.Op != 0 {
		n += 1 + sovPlanet(uint64(m.Op))
	}
	if m.ReqID != 0 {
		n += 1 + sovPlanet(uint64(m.ReqID))
	}
	if m.ParentReqID != 0 {
		n += 1 + sovPlanet(uint64(m.ParentReqID))
	}
	if m.TargetCellID != 0 {
		n += 1 + sovPlanet(uint64(m.TargetCellID))
	}
	if m.FromID != 0 {
		n += 1 + sovPlanet(uint64(m.FromID))
	}
	if m.AttrID != 0 {
		n += 1 + sovPlanet(uint64(m.AttrID))
	}
	if m.SI != 0 {
		n += 2 + sovPlanet(uint64(m.SI))
	}
	if m.ValType != 0 {
		n += 2 + sovPlanet(uint64(m.ValType))
	}
	l = len(m.ValBuf)
	if l > 0 {
...
func (m *UserSeat) Size() (n int) {
	...
	_ = l
	if m.UserID != 0 {
		n += 1 + sovPlanet(uint64(m.UserID))
	}
	if m.HomePlanetID != 0 {
		n += 1 + sovPlanet(uint64(m.HomePlanetID))
	}
	return n
}
...
func (m *AttrSchema) Size() (n int) {
	...
	if m.SchemaID != 0 {
		n += 1 + sovPlanet(uint64(m.SchemaID))
	}
	if len(m.Attrs) > 0 {
...
func (m *AttrSpec) Size() (n int) {
	...
	if m.SeriesType != 0 {
		n += 1 + sovPlanet(uint64(m.SeriesType))
	}
	if m.Fixed_SI != 0 {
		n += 1 + sovPlanet(uint64(m.Fixed_SI))
	}
	l = len(m.ValTypeURI)
	if l > 0 {
		n += 2 + l + sovPlanet(uint64(l))
...
func (m *AttrRange) Size() (n int) {
	...
	_ = l
	if m.SI_SeekTo != 0 {
		n += 2 + sovPlanet(uint64(m.SI_SeekTo))
	}
	if m.SI_StopAt != 0 {
		n += 2 + sovPlanet(uint64(m.SI_StopAt))
	}
	if m.SI_BatchLimit != 0 {
		n += 2 + sovPlanet(uint64(m.SI_BatchLimit))
	}
	return n
}
...
func (m *Content) Size() (n int) {
	...
	if m.ContentTypeID != 0 {
		n += 1 + sovPlanet(uint64(m.ContentTypeID))
	}
	if m.LinksCellID != 0 {
		n += 1 + sovPlanet(uint64(m.LinksCellID))
	}
	if m.Location != nil {
		l = m.Location.Size()
		n += 1 + l + sovPlanet(uint64(l))
...
func (m *CryptoKey) Size() (n int) {
	...
	_ = l
	if m.CryptoKitID != 0 {
		n += 1 + sovPlanet(uint64(m.CryptoKitID))
	}
	l = len(m.KeyBytes)
	if l > 0 {
		n += 1 + l + sovPlanet(uint64(l))
...
func (m *Link) Size() (n int) {
	...
	if m.CellID != 0 {
		n += 1 + sovPlanet(uint64(m.CellID))
	}
	if m.CellType != 0 {
		n += 1 + sovPlanet(uint64(m.CellType))
	}
	if m.ListOrder != 0 {
		n += 9
	}
...
func (m *TRS) Size() (n int) {
	...
	if m.ScaleMode != 0 {
		n += 2 + sovPlanet(uint64(m.ScaleMode))
	}
	if m.Scale1 != 0 {
		n += 6
	}
...
func (m *DataSegment) Size() (n int) {
	...
	_ = l
	if m.ByteOfs != 0 {
		n += 1 + sovPlanet(uint64(m.ByteOfs))
	}
	if m.ByteSz != 0 {
		n += 1 + sovPlanet(uint64(m.ByteSz))
	}
	l = len(m.InlineData)
	if l > 0 {
		n += 1 + l + sovPlanet(uint64(l))
...
func (this *Msg) String() string {
	...
	s := strings.Join([]string{`&Msg{`,
		...
		`ValFloat:` + fmt.Sprintf("%v", this.ValFloat) + `,`,
		`ValBufIsShared:` + fmt.Sprintf("%v", this.ValBufIsShared) + `,`,
...
func (this *AttrSchema) String() string {
	...
	s := strings.Join([]string{`&AttrSchema{`,
		...
		`DataModelURI:` + fmt.Sprintf("%v", this.DataModelURI) + `,`,
		`SchemaURI:` + fmt.Sprintf("%v", this.SchemaURI) + `,`,
...
func (this *AttrSpec) String() string {
	...
	s := strings.Join([]string{`&AttrSpec{`,
		...
		`Fixed_SI:` + fmt.Sprintf("%v", this.Fixed_SI) + `,`,
		`ValTypeURI:` + fmt.Sprintf("%v", this.ValTypeURI) + `,`,
		`}`,
	}, "")
	return s
}
func (this *PinReq) String() string {
	...
	s := strings.Join([]string{`&PinReq{`,
		`CellURI:` + fmt.Sprintf("%v", this.CellURI) + `,`,
		`SchemaID:` + fmt.Sprintf("%v", this.SchemaID) + `,`,
...
func (this *Link) String() string {
	...
	s := strings.Join([]string{`&Link{`,
		...
		`PlanetID:` + fmt.Sprintf("%v", this.PlanetID) + `,`,
		`CellID:` + fmt.Sprintf("%v", this.CellID) + `,`,
		`CellType:` + fmt.Sprintf("%v", this.CellType) + `,`,
		`ListOrder:` + fmt.Sprintf("%v", this.ListOrder) + `,`,
		`}`,
	}, "")
	return s
}
...
func valueToStringPlanet(v interface{}) string {
	rv := reflect.ValueOf(v)
	if rv.IsNil() {
		return "nil"
	}
	...
	for iNdEx < l {
		...
		case 6:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.TargetCellID |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		...
		case 23:
			...
			iNdEx += 8
			m.ValFloat = float64(math.Float64frombits(v))
		case 31:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field ValBufIsShared", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
...
func (m *AttrSchema) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field DataModelURI", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.DataModelURI = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 4:
			if wireType != 2 {
		...
		case 6:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.SchemaID |= uint32(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *AttrSpec) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 7:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field Fixed_SI", wireType)
			}
			m.Fixed_SI = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
		...
		case 22:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ValTypeURI", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.ValTypeURI = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipPlanet(dAtA[iNdEx:])
...
func (m *PinReq) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field CellURI", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.CellURI = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 3:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field SchemaID", wireType)
		...
		case 4:
			if wireType == 0 {
				...
				if elementCount != 0 && len(m.ChildSchemas) == 0 {
					m.ChildSchemas = make([]uint32, 0, elementCount)
				}
				for iNdEx < postIndex {
					var v uint32
					for shift := uint(0); ; shift += 7 {
...
func (m *Link) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 6:
			if wireType != 1 {
				return fmt.Errorf("proto: wrong wireType = %d for field ListOrder", wireType)
			}
			var v uint64
			if (iNdEx + 8) > l {
				return io.ErrUnexpectedEOF
			...
			v = uint64(encoding_binary.LittleEndian.Uint64(dAtA[iNdEx:]))
			iNdEx += 8
			m.ListOrder = float64(math.Float64frombits(v))
		default:
			iNdEx = preIndex
			skippy, err := skipPlanet(dAtA[iNdEx:])
			if err != nil {
