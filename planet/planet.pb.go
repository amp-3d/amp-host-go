...
type AttrSchema struct {
	...
	// This describes this *particular* AttrSchema, a particular collection of AttrSpecs (and is implicitly scoped within DataModelURI).
	// The host (and its apps) generally don't even look at this field since "{DataModelURI}/{Attrs[i].AttrURI}" fully specifies each attr's data model URI.
...
type PinReq struct {
	...
	// Specifies an AttrSchema for the parent cell to be pinned, which specifies which attrs of the parent cell will be pushed to the client.
	ParentSchemaID int32 `protobuf:"varint,3,opt,name=ParentSchemaID,proto3" json:"ParentSchemaID,omitempty"`
	...
	ChildSchemas []int32 `protobuf:"varint,4,rep,packed,name=ChildSchemas,proto3" json:"ChildSchemas,omitempty"`
}
...
func (m *PinReq) GetParentSchemaID() int32 {
	if m != nil {
...
var fileDescriptor_100f8d53602fc3e1 = []byte{
	...
	,
}
...
func (this *PinReq) GoString() string {
	...
	s = append(s, "ParentSchemaID: "+fmt.Sprintf("%#v", this.ParentSchemaID)+",\n")
...
func (m *AttrSchema) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.SchemaName) > 0 {
		...
		i = encodeVarintPlanet(dAtA, i, uint64(len(m.SchemaName)))
		i--
		dAtA[i] = 0x22
	}
...
func (m *PinReq) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.ParentSchemaID != 0 {
		i = encodeVarintPlanet(dAtA, i, uint64(m.ParentSchemaID))
		i--
		dAtA[i] = 0x18
	}
	if len(m.CellURI) > 0 {
...
func (m *PinReq) Size() (n int) {
	...
	if m.ParentSchemaID != 0 {
		n += 1 + sovPlanet(uint64(m.ParentSchemaID))
	}
	if len(m.ChildSchemas) > 0 {
		l = 0
...
func (this *PinReq) String() string {
	...
	s := strings.Join([]string{`&PinReq{`,
		...
		`ParentSchemaID:` + fmt.Sprintf("%v", this.ParentSchemaID) + `,`,
	...
	for iNdEx < l {
		...
		case 3:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.ParentSchemaID |= int32(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
