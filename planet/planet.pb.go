...
const (
	...
	//
	// Params:
	//      Msg.ParentReqID:  parent context
	//      Msg.ReqID:        newly client-generated (unique) request ID
...
type AttrSchema struct {
	...
	// The reserved value "." tells the host to choose the default app registered to handle the below DataModelURI (common).
	// e.g.
	//      "."
	...
	// SchemaURI names this particular AttrSchema, a particular collection of AttrSpecs (and so is implicitly scoped within DataModelURI).
	// Typically, a UI Cell view specifies a unique SchemaURI for the set of attrs it wants to display, meaning this field tends to correspond to a particular cell "view".
	// The host (and its apps) don't typically even look at this URI since "{DataModelURI}/{Attrs[i].AttrURI}" specifies each attr's data model URI.
...
var fileDescriptor_100f8d53602fc3e1 = []byte{
	...
	,
}
