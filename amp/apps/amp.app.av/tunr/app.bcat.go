...
var (
	AppSpec         = av.AppSpec.With("bookmark-catalog")
	LoginInfoAttrID = AppSpec.With("LoginInfo").ID
)
...
func (app *appInst) readStoredToken() error {
	...
	// Pins the named cell relative to the user's home space and appID (guaranteeing app and user scope)
	login := &av.LoginInfo{}
