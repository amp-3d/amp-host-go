...
// Sharepoint specifies a local file system path root to shore (serve)
type Sharepoint struct {
	// LocalRoot is the local file system path root to share (serve)
	LocalRoot   string `protobuf:"bytes,1,opt,name=LocalRoot,proto3" json:"LocalRoot,omitempty"`
	AllowUpload bool   `protobuf:"varint,2,opt,name=AllowUpload,proto3" json:"AllowUpload,omitempty"`
}

func (m *Sharepoint) Reset()      { *m = Sharepoint{} }
func (*Sharepoint) ProtoMessage() {}
func (*Sharepoint) Descriptor() ([]byte, []int) {
	return fileDescriptor_e4af60a362d267ef, []int{1}
}
func (m *Sharepoint) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *Sharepoint) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_Sharepoint.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *Sharepoint) XXX_Merge(src proto.Message) {
	xxx_messageInfo_Sharepoint.Merge(m, src)
}
func (m *Sharepoint) XXX_Size() int {
	return m.Size()
}
func (m *Sharepoint) XXX_DiscardUnknown() {
	xxx_messageInfo_Sharepoint.DiscardUnknown(m)
}

var xxx_messageInfo_Sharepoint proto.InternalMessageInfo

func (m *Sharepoint) GetLocalRoot() string {
	if m != nil {
		return m.LocalRoot
	}
	return ""
...
func (m *Sharepoint) GetAllowUpload() bool {
	if m != nil {
		return m.AllowUpload
	}
	return false
}
...
func (*MediaPlaylist) Descriptor() ([]byte, []int) {
	return fileDescriptor_e4af60a362d267ef, []int{6}
}
...
func (*MediaProviderInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_e4af60a362d267ef, []int{7}
}
...
func init() {
	...
	proto.RegisterType((*Sharepoint)(nil), "amp.Sharepoint")
...
var fileDescriptor_e4af60a362d267ef = []byte{
	...
	,
}
...
func (this *Sharepoint) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*Sharepoint)
	if !ok {
		that2, ok := that.(Sharepoint)
		if ok {
			that1 = &that2
		} else {
			return false
	...
	if this.LocalRoot != that1.LocalRoot {
		return false
	}
	if this.AllowUpload != that1.AllowUpload {
		return false
	}
	return true
}
...
func (this *Sharepoint) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 6)
	s = append(s, "&amp.Sharepoint{")
	s = append(s, "LocalRoot: "+fmt.Sprintf("%#v", this.LocalRoot)+",\n")
	s = append(s, "AllowUpload: "+fmt.Sprintf("%#v", this.AllowUpload)+",\n")
	s = append(s, "}")
	return strings.Join(s, "")
}
...
func (m *Sharepoint) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *Sharepoint) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *Sharepoint) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if len(m.LocalRoot) > 0 {
		i -= len(m.LocalRoot)
		copy(dAtA[i:], m.LocalRoot)
		i = encodeVarintAmp(dAtA, i, uint64(len(m.LocalRoot)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (this *Sharepoint) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&Sharepoint{`,
		`LocalRoot:` + fmt.Sprintf("%v", this.LocalRoot) + `,`,
		`AllowUpload:` + fmt.Sprintf("%v", this.AllowUpload) + `,`,
		`}`,
	}, "")
	return s
}
...
func (m *Sharepoint) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: Sharepoint: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: Sharepoint: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field LocalRoot", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.LocalRoot = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 2:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field AllowUpload", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
